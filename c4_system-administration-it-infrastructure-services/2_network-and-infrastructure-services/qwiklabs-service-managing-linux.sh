...
sudo service cups status # This is the service used to manage printers on Linux systems. get more information about failure services
...
sudo date -s '2022-08-29 00:00:00' # manually change the date
date # check the date
